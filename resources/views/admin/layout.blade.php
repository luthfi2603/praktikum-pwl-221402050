    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
                ...
                <div class="sidebar-brand-text mx-3">Luthfi</div>
            </a>
            ...
            <!-- Nav Item - Lagu -->
            <li class="nav-item {{ request()->is('admin/lagu') ? 'active' : ''}}">
                <a class="nav-link" href="/admin/lagu">
            ...
            <!-- Nav Item - Fisika -->
            <li class="nav-item {{ request()->is('admin/fisika') ? 'active' : ''}}">
                <a class="nav-link" href="/admin/fisika">
                    <i class="fas fa-fw fa-ruler"></i>
                    <span>Fisika</span>
                </a>
            </li>

            <!-- Nav Item - Senyawa Kimia -->
            <li class="nav-item {{ request()->is('admin/senyawa') ? 'active' : ''}}">
                <a class="nav-link" href="/admin/senyawa">
                    <i class="fas fa-fw fa-flask"></i>
                    <span>Senyawa Kimia</span>
                </a>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="{{asset('assets2/img/undraw_profile_2.svg')}}"
                                            alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="{{asset('assets2/img/undraw_profile_3.svg')}}"
                                            alt="...">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Muhammad Luthfi</span>
                                <img class="img-profile rounded-circle"
                                    src="{{asset('assets2/img/poto_profil.jpg')}}">
                            </a>
                ...
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>
                            ...
                            Copyright 2023 &copy; Muhammad Luthfi
                        </span>
                    </div>
                </div>
            </footer>
